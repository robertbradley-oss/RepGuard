...
```text
/claimguardagent prepare Phase 4.21 OpenAI Vision sandbox schema planning only: define the future schema versioning, field validation rules, required/optional field behavior, refusal/failure schema variants, privacy/retention flag schema, and contract probe expectations; do not add SDKs/env vars/providers/uploads/storage/persistence/UI/live analyzer wiring, do not process real evidence, do not change existing routes, and do not start live AI/Vision/photo analysis
```
