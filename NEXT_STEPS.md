...
```text
/claimguardagent prepare Phase 4.24 synthetic fixture metadata schema planning only: define the future metadata shape for OpenAI Vision sandbox fixtures and package/distribution status, still no fixture files/images, no SDKs/env vars/providers/uploads/storage/persistence/UI/live analyzer wiring, no real evidence, no existing route changes, and no live AI/Vision/photo analysis
```
