...
```text
/claimguardagent start Phase 4.31 OpenAI Vision sandbox skeleton implementation as script/module-only developer sandbox work: no SDKs, env vars, provider calls, new route, existing route behavior changes, upload/storage/persistence, UI wiring, runtime schema/types unless separately approved, fixture changes, package artifacts, real evidence, analyzeEvidenceFile changes, LocalAnalysisResult changes, receipt behavior changes, or deployment
```
