...
```text
/claimguardagent pause after Phase 2.7.3, or create a docs-only Phase 2.7.4 planning checkpoint for the next live-opt-in readiness question; do not implement runtime, add unsupported-evidence UI, wire the wrapper into live callers, route ProductPhotoReviewPanel, change upload/report/parser/scoring/fixtures, commit, push, or deploy unless explicitly approved
```
