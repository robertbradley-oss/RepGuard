...
```text
/claimguardagent prepare Phase 4.23 OpenAI Vision sandbox validation/probe planning only: define future validation checks and probe expectations for the planned sandbox schema, prompt/output contract, and fixture policy; do not add SDKs/env vars/providers/uploads/storage/persistence/UI/live analyzer wiring, do not add fixture files/images, do not process real evidence, do not change existing routes, and do not start live AI/Vision/photo analysis
```
