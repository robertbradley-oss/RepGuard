...
```text
/claimguardagent run Phase 4.0 planning-only real AI/OCR/photo intelligence readiness under the roadmap heading "Phase 4: Stronger OCR and AI Integrations"; do not implement real AI, OCR, photo analysis, upload behavior, persistence, provider/storage/integration work, live scoring, ClaimReviewWorkflow wiring, ProductPhotoReviewPanel routing, or receipt behavior changes until the planning checkpoint explicitly approves scope
```
