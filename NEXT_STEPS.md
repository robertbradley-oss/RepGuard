...
```text
/claimguardagent prepare Phase 4.22 OpenAI Vision sandbox fixture-policy planning only: define synthetic fixture categories, later-approved redacted/anonymized fixture gates, prohibited real-evidence inputs, fixture naming rules, fixture privacy scans, and validation/probe expectations; do not add SDKs/env vars/providers/uploads/storage/persistence/UI/live analyzer wiring, do not process real evidence, do not change existing routes, and do not start live AI/Vision/photo analysis
```
