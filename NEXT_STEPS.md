...
1. Run Phase 2.4.9 as docs-only pre-OCR/pre-metadata unsupported boundary planning for product-photo-like files before any dev-only adapter harness, upload, UI, live report mapping, `analyzeEvidenceFile`, `LocalAnalysisResult`, provider, storage, integration, case queue, real photo, real metadata fixture, deployment, or runtime work.
