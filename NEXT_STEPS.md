...
```text
/claimguardagent stop after Phase 4.29 and prepare a handoff only; do not start Phase 4.30, OpenAI Vision sandbox skeleton planning, provider implementation, SDK/env work, provider calls, upload wiring, route/runtime/UI changes, package artifacts, or real evidence processing
```
