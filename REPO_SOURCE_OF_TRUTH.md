...
- The next safe task is Phase 4.0 planning-only real AI/OCR/photo intelligence readiness under `ROADMAP.md` heading "Phase 4: Stronger OCR and AI Integrations". Do not implement real AI, OCR, photo analysis, provider calls, upload behavior, persistence, live scoring, or real evidence handling until Phase 4 planning explicitly approves scope.
