...
- The next safest move is review and, if approved, commit the Phase 2.8.2 implementation. Do not wire the wrapper into live callers or change runtime/UI/upload/report behavior without explicit approval.
