...
- The next safest move is review and, if approved, commit the docs-only Phase 2.7.5 workflow/caller boundary opt-in design. Do not wire the wrapper into live callers or change runtime/UI/upload/report behavior without explicit approval.
