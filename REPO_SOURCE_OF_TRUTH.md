...
- The next safest move is Phase 2.8.0 docs-only acceleration planning toward dev-only harness/UI readiness for the unsupported-evidence workflow-boundary bridge. Do not wire the wrapper into live callers or change runtime/UI/upload/report behavior without explicit approval.
