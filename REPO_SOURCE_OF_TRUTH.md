...
- The next safest task is review/commit of the Phase 2.7.2 docs-only plan. Do not wire the wrapper into live callers or change runtime/UI/upload/report behavior without explicit approval.
