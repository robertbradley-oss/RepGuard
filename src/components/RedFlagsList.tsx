...
import type { RedFlag } from "@/lib/claim-data";
  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between gap-3">
        <h2 className="text-lg font-semibold text-[#0b1f3a]">Red flags</h2>
        <span className="text-sm font-medium text-slate-500">{flags.length} signals</span>
      </div>
