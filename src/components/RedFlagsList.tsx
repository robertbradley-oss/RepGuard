  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-4">
      ...
      <div className="mt-4 space-y-2.5">
        ...
        {!isPending &&
          flags.map((flag) => (
            <article className="rounded-lg border border-slate-200 bg-white p-3" key={flag.label}>
              <div className="flex items-start gap-3">
                <span className="mt-0.5 flex size-8 shrink-0 items-center justify-center rounded-md bg-slate-50 text-amber-700 ring-1 ring-slate-200">
