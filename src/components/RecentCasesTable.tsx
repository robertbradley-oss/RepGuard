  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <button className="rounded-md bg-[#0b1f3a] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#102b50]">
          View all
        </button>
      </div>
      ...
      <div className="mt-5 overflow-x-auto">
        <table className="w-full min-w-[760px] border-separate border-spacing-0 text-left text-sm">
          ...
          <tbody>
            {cases.map((claim) => (
              <tr className="text-slate-700" key={claim.id}>
                ...
                <td className="border-b border-slate-100 py-4">{claim.item}</td>
                <td className="border-b border-slate-100 py-4">
