...
- The next safe task is Phase 4.10 provider abstraction planning only. Live OCR/provider work remains blocked unless Robert explicitly opens a named live/provider implementation slice.
