...
- The next safe task is Phase 4.9 provider selection planning only, OCR provider abstraction planning only, or developer-only route access guard planning if needed. Live OCR/provider work remains blocked unless Robert explicitly opens a named live/provider implementation slice.
