...
- The recommended next safe task is Phase 4.40 API-credit usage approval decision and first live sandbox call plan. Do not start live OpenAI Vision implementation unless Robert explicitly approves Choice B/API-credit-using work.
